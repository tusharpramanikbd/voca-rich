      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl p-4 shadow-lg border border-white/50">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 bg-white/50 border border-gray-200 rounded-xl px-4 py-3 text-lg placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500"
